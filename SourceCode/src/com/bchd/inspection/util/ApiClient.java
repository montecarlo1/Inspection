...
import com.bchd.inspection.APPConfigMgr;
...
/*	private static String appCookie;
	...
	private static GetMethod getHttpGet(String url, String cookie, String userAgent) {
		...
		httpGet.setRequestHeader("Host",APPConfigMgr.HOST);
	...
	private static PostMethod getHttpPost(String url, String cookie, String userAgent) {
		...
		httpPost.setRequestHeader("Host", APPConfigMgr.HOST);
	...
	public static Update checkVersion(AppContext appContext) throws AppException {
		try{
			return Update.parse(http_get(appContext, APPConfigMgr.UPDATE_VERSION));		
		}catch(Exception e){
